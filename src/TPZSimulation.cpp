...
TPZString TPZSimulation :: writeSimulationStatus()
{
   ...
   // try to track how many flit has been injected.
   // check if the amount is equal to that of the simulator.
   buffer += TPZString("\nThe amount of flit injected = ") + TPZString(m_Network->getHeadTailCount()) + TPZString("\n");
