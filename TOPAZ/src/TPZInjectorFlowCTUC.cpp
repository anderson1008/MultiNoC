...
//*************************************************************************
//:
//    File: TPZInjectorFlowCTUC.cpp
//
//    Class:  TPZInjectorFlowCTUC
//
//    Inherited from:  TPZInjectorFlowCT
// :
//*************************************************************************
//end of header
...
IMPLEMENT_RTTI_DERIVED(TPZInjectorFlowCTUC,TPZInjectorFlowCT);
...
TPZInjectorFlowCTUC :: TPZInjectorFlowCTUC(TPZComponent& component)
                   : TPZInjectorFlowCT(component)
{
...
TPZInjectorFlowCTUC :: ~TPZInjectorFlowCTUC()
{
